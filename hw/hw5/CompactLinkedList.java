...
public class CompactLinkedList<T> extends AbstractSequentialList<T> {
    ...
    private class CompactIterator implements ListIterator<T> {
        ...
        @Override
        public T next() {
            _link[_first + 1] = _next ^ _prev;
            _first += 1;
            return _data[_link[_first]];
        }
        ...
        @Override
        public T previous() {
            _link[_first + _last] = _next ^ _prev;
            _last = _first - 1;
            _first -= 1;
            return _data[_link[_last]];
        }
        ...
        public void add(T obj) {
            ...
            if (_size == _data.length) {
                ...
                int addIndex = (_next - 1) ^ _prev;
                _data[_link[addIndex]] = obj;
            }
        }
